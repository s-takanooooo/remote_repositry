    ...
    <div class="row mt-4">
        <form method="post" action="#">
            <div class="row offset-2 col-8 my-4">
                ...
                <div class="col-8">
                    <input type="text" class="col-12 border rounded px-4 fs-3" placeholder="${name}" readonly>
                </div>
            </div>
            ...
            <div class="row offset-2 col-8 my-4">
                ...
                <div class="col-8">
                    <input type="text" class="col-12 border rounded px-4 fs-3" placeholder="${mail}" readonly>
                </div>
            </div>
            ...
            <div class="row offset-2 col-8 my-4">
                ...
                <div class="col-8">
                    <input type="text" class="col-12 border rounded px-4 fs-3" placeholder="${pass}" readonly>
                </div>
            </div>
            ...
            <div class="row offset-2 col-8 my-4">
                ...
                <div class="col-8">
                    <input type="text" class="col-12 border rounded px-4 fs-3" placeholder="${pass_confirm}" readonly>
                </div>
            </div>
