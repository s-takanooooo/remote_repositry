	 ...
	 <nav class="navbar navbar-expand-md bg-body-tertiary p-0">
        <div class="container-fluid p-0">
            ...
            <div class="collapse navbar-collapse p-0" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item mx-2 p-3 ${current == 'active1' ? 'current' : ''}  ">
                        <a class="nav-link fs-5" href="C0020">ダッシュボード</a>
                    </li>
                    <li class="nav-item mx-2 p-3 ${current == 'active2' ? 'current' : ''}">
                        <a class="nav-link fs-5" href="S0010">売上登録</a>
                    </li>
                    <li class="nav-item mx-2 p-3 ${current == 'active3' ? 'current' : ''}">
                        <a class="nav-link fs-5" href="S0020">売上検索</a>
                    </li>
                    <li class="nav-item mx-2 p-3 ${current == 'active4' ? 'current' : ''}">
                        <a class="nav-link fs-5" href="S0030">アカウント登録</a>
                    </li>
                    <li class="nav-item mx-2 p-3 ${current == 'active5' ? 'current' : ''}">
